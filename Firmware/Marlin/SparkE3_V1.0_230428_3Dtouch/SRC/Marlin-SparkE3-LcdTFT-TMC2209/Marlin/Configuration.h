...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_GTM32_SPARK_E2
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -4 }
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X 17579
  #define TOUCH_CALIBRATION_Y 13694
  #define TOUCH_OFFSET_X -29
  #define TOUCH_OFFSET_Y -56
