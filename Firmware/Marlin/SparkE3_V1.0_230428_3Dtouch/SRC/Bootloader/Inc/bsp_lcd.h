...
#define FSMC_LCD_CMD                   ((uint32_t)0x6001fffE)	    //FSMC_Bank1_NORSRAM1用于LCD命令操作的地址
...
#define LCD_BK_ON()                    HAL_GPIO_WritePin(FSMC_LIGHT_GPIO_Port, FSMC_LIGHT_Pin, GPIO_PIN_SET);
#define LCD_BK_OFF()                   HAL_GPIO_WritePin(FSMC_LIGHT_GPIO_Port, FSMC_LIGHT_Pin, GPIO_PIN_RESET);
